...
public class DaoBox {
    ...
    public void insert(Integer user_ID,String nfc,String box_name,String box_pos){
    ...
    //删除盒子：需给定用户ID、盒子名称
    public void delete(Integer user_ID,String box_name){
        SQLiteDatabase db=mDataBaseHelper.getWritableDatabase();
    ...
    public void updateName(Integer user_ID,String box_oldName,String box_newName){
        SQLiteDatabase db=mDataBaseHelper.getWritableDatabase();
    ...
    public void updatePos(Integer user_ID,String box_oldPos,String box_newPos){
        SQLiteDatabase db=mDataBaseHelper.getWritableDatabase();
        String sql="update " + GuanContract.Box.TABLE_NAME + " set box_name=?,updated_time=? where user_ID=? and box_name=?";
        Date date = new Date();
        long currentTime = date.getTime();
    ...
    public boolean query(Integer user_ID,String box_name){
        SQLiteDatabase db=mDataBaseHelper.getWritableDatabase();
